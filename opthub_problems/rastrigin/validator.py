"""This file defines the schema for the rastrigin function problem."""
...
# Schema to validate the optima of the rastrigin function
OPTIMA_SCHEMA = """{
    "$schema": "http://json-schema.org/draft-07/schema#",
    "title": "Optima of the rastrigin function.",
    "type": "array",
    "minItems": 1,
    "items": {
        "type": "array",
...
def validate_optima(optima: Any) -> list[list[float]]:  # noqa: ANN401
    """Validate the optima of the rastrigin function.

    Args:
        optima (Any): optima environment variable of the rastrigin function
...
# Schema to validate the variable of the rastrigin function with n decision dimensions
VARIABLE_ND_SCHEMA = """{{
    "$schema": "http://json-schema.org/draft-07/schema#",
    "title": "Variable of the rastrigin function with n decision dimensions.",
    "type": "array",
    "minItems": {items},
    "maxItems": {items},
    "items": {{"type": "number"}}
...
# Schema to validate the variable of the rastrigin function with 1 decision dimension
VARIABLE_1D_SCHEMA = """{
    "$schema": "http://json-schema.org/draft-07/schema#",
    "title": "Variable of the rastrigin function with 1 decision dimension.",
    "type": "number"
}"""


def validate_variable(variable: Any, dim: int) -> float | list[float]:  # noqa: ANN401
    """Validate the variable of the rastrigin function.
